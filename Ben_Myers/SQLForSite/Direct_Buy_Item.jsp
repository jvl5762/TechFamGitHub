...
// 					username (String) 	- username of person buying the item
//					amount (Integer)	- amount of ites person is buyting
//					credit_card (Long)	- credit card number
//					address_id (Integer)- address for the credit card
...
try{
	...
	if(count >= amount){
		...
		add_to_sale.setString(6, request.getParameter("username"));
		
		add_to_sale.setLong(7, Long.parseLong(request.getParameter("credit_card")));
		
		add_to_sale.setInt(8, Integer.parseInt(request.getParameter("address_id")));
