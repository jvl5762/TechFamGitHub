...
try{
	...
	insert_sales_item.setInt(10, Integer.parseInt(request.getParameter("supplier_id")));

	insert_sales_item.setInt(11, Integer.parseInt(request.getParameter("address_id")));
...
String redirectURL = "AddProductForm.jsp";
